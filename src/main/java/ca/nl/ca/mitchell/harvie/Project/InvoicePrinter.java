...
/**
 * Invoice printer class for printing invoices in a clean format
 */
public class InvoicePrinter {

    /**
     * Prints the invoice in clean format, including customer details,
    ...
    public void printInvoice(Invoice invoice) {
        ...
        System.out.println("-".repeat(71));
        System.out.printf("| %-2s | %-40s | %-6s | %-10s | %-11s |%n", "#", "Description", "Qty", "Unit Price", "Total");
        System.out.println("-".repeat(71));
        ...
        for (int i = 0; i < invoice.getInvoiceItems().length; i++) {
            ...
            if (item != null) {
                ...
                System.out.printf("| %-2d | %-40s | %-6s | $%-9.2f | $%-10.2f |%n",
                        i + 1,
        ...
        System.out.println("-".repeat(71));
        System.out.printf("| %67s | $%-10.2f |%n", "Subtotal:", invoice.getInvoiceTotal());
        System.out.printf("| %67s | $%-10.2f |%n", "Sales Tax (13%):", invoice.getInvoiceTotalWithTax() - invoice.getInvoiceTotal());
        System.out.printf("| %67s | $%-10.2f |%n", "TOTAL:", invoice.getInvoiceTotalWithTax());
        System.out.println("-".repeat(71));
        System.out.println();
